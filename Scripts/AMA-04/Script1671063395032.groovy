...
Mobile.tap(findTestObject('Object Repository/product_detail/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/product_detail/android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/product_detail/android.view.ViewGroup (1)'), 0)

Mobile.tap(findTestObject('Object Repository/product_detail/android.view.ViewGroup (2)'), 0)
